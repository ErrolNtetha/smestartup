        ...
        <div className='landingContainer'>
           <section className='heroSection'>
                <article className='leftColumn'>
                    ...
                    <Link to='/signup'> <span> get started </span> <span> <FaArrowRight className='arrow-right' /> </span> </Link>
           ...
           <section className="suggestions">
                ...
                <span>
                    ...
                    <form action="">
                        ...
                        <textarea style={{ fontFamily: "sans-serif" }} placeholder='Please write to us and we shall get back to you' name="suggestion" id="" cols="30" rows="10"></textarea>
