  ...
  return (
    <section className='features'>
        <section className='features__innerSection'>
            <section className='features__innerText'>
                <section className='features__innerText'>
                    <span className='features__item'>
                        <span className='features__headerText'>
                            <h1> Discover a new world of community for entrepreneurs in your fingertips. </h1>
                            <h4 className='features__header'> Fancy a partnership... </h4>
                        </span>
                  ...
                  <span className='features__item'>
                    <h4 className='features__header'> Find Suppliers for your business </h4>
                  ...
                  <span className='features__item'>
                    <h4 className='features__header'> Seek inspirations from peers </h4>
