...
import { levels } from '../page/register/bee';
...
export const UpdateSupplier = () => {
    ...
    const { loading, data } = useFetchData(`/suppliers/${id}`);
    return (
        loading
            ? <Loading content='article' className='supplier__updateLoadingContainer' />
            : (
            ...
            <Formik
              ...
              initialValues={{
                  ...
                  pictures: [data?.suppliers?.photos],
                  avatar: data?.suppliers?.avatar,
                  about: data?.suppliers?.about,
                  established: data?.suppliers?.established,
                  contacts: {
                    email: data?.suppliers?.contacts.email,
                    website: data?.suppliers?.contacts.website,
                    cellphone: data?.suppliers?.cellphone,
                    telephone: data?.suppliers?.telephone,
                    fax: data?.suppliers?.fax,
                },
                  description: data?.suppliers?.description,
                  addresses: data?.suppliers?.addresses,
                  beeLevel: data?.suppliers?.beeLevel,
                  sector: data?.suppliers?.sector,
                  moq: data?.suppliers?.moq,
                  moqNumber: data?.suppliers?.moqNumber,
                  quotation: data?.suppliers?.quotation,
                  companyType: data?.suppliers?.type
            }}
              onSubmit={async (values) => {
                  await axiosPrivate.put(`/suppliers/${id}/update`, values)
                  .then((response) => {
                ...
                <section className='profile__avatarContainer'>
                    ...
                    <section>
                        ...
                        <Field
                          ...
                          value={data?.suppliers?.contacts.email}
                          className='profile__input'
                        />
                    </section>
                    ...
                    <section>
                        ...
                        <Field
                          type='number'
                          value={props.values.established}
                          name='established'
                    ...
                    <section className='profile__actionBtns'>
                        ...
                        <Button type='submit' disabled={props.isSubmitting} className='profile__button--save'>
                            {props.isSubmitting ? <SyncLoader color='white' size={6} /> : 'Update' }
                        </Button>
                    </section>
              </Form>
          )}
